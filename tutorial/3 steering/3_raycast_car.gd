...
@export var wheels: Array[RaycastWheelTut3]
...
func _do_single_wheel_traction(ray: RaycastWheelTut3, idx: int) -> void:
...
func _do_single_wheel_acceleration(ray: RaycastWheelTut3) -> void:
...
func _do_single_wheel_suspension(ray: RaycastWheelTut3) -> void:
	if ray.is_colliding():
